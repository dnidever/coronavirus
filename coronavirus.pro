...
xyouts,5,2000,stringize(usdouble,ndec=1)+' days (last 32 days)',align=0,charsize=1.7,co=50
...
xyouts,5,1100,stringize(usdouble_thisweek,ndec=1)+' days (last 12 days)',align=0,charsize=1.7,co=90
